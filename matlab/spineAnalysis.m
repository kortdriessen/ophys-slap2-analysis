classdef spineAnalysis < handle
    ...
    methods
        function obj = spineAnalysis(arg1)
            ...
            obj.IMavg = mean(obj.IM,obj.timeDim, 'omitnan');
        ...
        function updateDisplay(obj)
            set(obj.hIm, 'CData',cat(3, obj.IMc(:,:,obj.showChannel)./obj.Clevel, obj.IMavg(:,:,obj.showChannel), obj.IMavg(:,:,obj.showChannel)))
        end
        ...
        function sData = analyze(obj, arg1, arg2)
            ...
            for pix = 1:nROIs
                for cix = 1:obj.numChannels
                    ...
                    tNorm = sData.trace2(:,pix,cix)./sData.n2(rix,cix); %normalized trace
